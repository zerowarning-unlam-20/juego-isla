...
class GenderTest {
	...
	public void GenderTest1() {
		Location testLocation = new Location(Gender.M, "s1", "Inicio", true, true, null, null);
	...
	public void GenderTest2() {
		Location testLocation = new Location(Gender.F, "Cueva", "Cueva oscura", true, true, null, null);
