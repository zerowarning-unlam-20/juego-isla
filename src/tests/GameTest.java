...
class GameTest {
	...
	@Test
	void test() {
		Location s1 = new Location(1, "s1", "Inicio", true);
		s1.addAccess(new Access(12, "Puerta", "Puerta azul", true, false, true, 2, 0));

		Location s2 = new Location(2, "s2", "Segundo lugar", true);
		...
		Location s3 = new Location(3, "s3", "Tercer lugar", true);
		...
		Location s4 = new Location(4, "s4", "Cuarto lugar", true);
		...
		Location s5 = new Location(5, "s5", "Quinto lugar", true);
		...
		Location s6 = new Location(6, "s6", "Sexto lugar", true);
